...
import ReceiversModel from '../models/receivers.model.js';
...
export default class ReceiversCoordinator { // making this a class so that I can export then use the methods I create within the class in other modules
  static getReceivers = (sortDirection) => ReceiversModel.getReceivers(sortDirection); // have to return something here because this is what you will be passing to the controller..and what I'm returning is the return value from getReciever in my ReceiversModel class which is my array simualting a DB
